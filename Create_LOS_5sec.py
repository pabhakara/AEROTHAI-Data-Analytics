...
# date_list = pd.date_range(start='2025-02-17', end='2025-02-17')
...
with (conn_postgres):
    ...
    for date in date_list[:]:
        ...
        postgres_sql_text = f"DROP TABLE IF EXISTS los.los_{year}_{month}_{day}; " \
                            ...
                            f"GRANT USAGE ON SCHEMA los TO ponlawatwa; " \
                            f"GRANT SELECT ON ALL TABLES IN SCHEMA los TO ponlawatwa; " \
