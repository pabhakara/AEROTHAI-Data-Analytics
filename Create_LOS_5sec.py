        ...
        for month in month_list:
            ...
            # the Postgres SQL database
                postgres_sql_text = f"DROP TABLE IF EXISTS los.los_{year}_{month}_{day}; " \
                                    ...
                                    f"public.ST_Transform(a.\"2d_position\",3857), " \
                                    "public.ST_Transform(b.\"2d_position\",3857))/1852 as horizontal_separation, " \
                                    "abs(a.measured_fl - b.measured_fl) as vertical_separation, " \
                                    "public.ST_MakeLine(a.\"2d_position\",b.\"2d_position\") as \"geom\", " \
                                    ...
                                    "AND public.ST_Distance(public.ST_Transform(a.\"2d_position\",3857), " \
                                    "public.ST_Transform(b.\"2d_position\",3857))/1852 < 8 " \
