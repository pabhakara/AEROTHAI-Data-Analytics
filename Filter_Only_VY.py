...
with conn_postgres:
    ...
    postgres_sql_text = f" DROP SCHEMA IF EXISTS {schema_name}_vy CASCADE;" \
                        f" CREATE SCHEMA IF NOT EXISTS {schema_name}_vy; " \
    ...
    postgres_sql_text = f" SELECT * " \
                        f" INTO {schema_name}_vy.tbl_header" \
