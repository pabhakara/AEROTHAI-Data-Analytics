def create_runway_segments_extended(db_name,schema_name):
    ...
    table_name = 'runway_segments_extended'
        ...
        for airport_id in airport_identifier_list:  # each airport identifier
            ...
            for runway_id_1 in runway_identifier_list:  # each runway identifier
                ...
                if not (len(results) == 0):
                    ...
                    runway_length_m_2 = runway_length_m + 2000

                    if 0 < runway_true_bearing < 90:
                        runway_2_x = runway_1_xy[0] + runway_length_m_2 * math.cos(runway_true_bearing * math.pi/180)
                        runway_2_y = runway_1_xy[1] + runway_length_m_2 * math.sin(runway_true_bearing * math.pi/180)
                    elif 90 < runway_true_bearing < 180:
                        runway_2_x = runway_1_xy[0] + runway_length_m_2 * math.cos((runway_true_bearing - 90) * math.pi / 180)
                        runway_2_y = runway_1_xy[1] - runway_length_m_2 * math.sin((runway_true_bearing - 90) * math.pi / 180)
                    elif 180 < runway_true_bearing < 270:
                        runway_2_x = runway_1_xy[0] - runway_length_m_2 * math.cos((runway_true_bearing - 180) * math.pi/180)
                        runway_2_y = runway_1_xy[1] - runway_length_m_2 * math.sin((runway_true_bearing - 180) * math.pi/180)
                    else:
                        runway_2_x = runway_1_xy[0] - runway_length_m_2 * math.cos((runway_true_bearing - 270) * math.pi / 180)
                        runway_2_y = runway_1_xy[1] + runway_length_m_2 * math.sin((runway_true_bearing - 270) * math.pi / 180)
