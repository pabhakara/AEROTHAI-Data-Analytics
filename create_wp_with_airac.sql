...
drop table if exists "sids_wp_2113";
select *,
ST_SetSRID(ST_MakePoint(waypoint_longitude,waypoint_latitude),4326) AS geom
into "sids_wp_2113"
from "tbl_sids";

drop table if exists "stars_wp_2113";
select *,
ST_SetSRID(ST_MakePoint(waypoint_longitude,waypoint_latitude),4326) AS geom
into "stars_wp_2113"
from "tbl_stars";

drop table if exists "iaps_wp_2113";
select *,
ST_SetSRID(ST_MakePoint(waypoint_longitude,waypoint_latitude),4326) AS geom
into "iaps_wp_2113"
from "tbl_iaps";

drop table if exists "terminal_ndb_2113";
select *,
ST_SetSRID(ST_MakePoint(ndb_longitude,ndb_latitude),4326) AS geom
into "terminal_ndb_2113"
from "tbl_terminal_ndbnavaids";

drop table if exists "terminal_waypoints_2113";
select *,
ST_SetSRID(ST_MakePoint(waypoint_longitude,waypoint_latitude),4326) AS geom
into "terminal_waypoints_2113"
from "tbl_terminal_waypoints";

drop table if exists "vor_2113";
select *,
ST_SetSRID(ST_MakePoint(vor_longitude,vor_latitude),4326) AS geom
into "vor_2113"
from "tbl_vhfnavaids";

drop table if exists "dme_2113";
select *,
