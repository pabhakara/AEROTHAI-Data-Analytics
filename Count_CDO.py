...
def count_cdo(year, month, day):
    ...
    postgres_sql_text = f"SELECT flight_key,actype, first_flevel,measured_fl, ROUND(count::numeric*5/60,2) as minutes "\
                        ...
                        f"AND (f.dest LIKE 'VTBS' OR f.dest LIKE 'VTBD') "\
...
date_list = pd.date_range(start='2024-09-01', end='2024-09-20', freq='D')
...
equipage_count_df.to_csv(f"/Users/pongabha/Library/CloudStorage/Dropbox/Workspace/CAAT/AND/KPI/KPI 2566/num_of_cdo_Sep_2024.csv")
