...
x_vect = np.array([C[0],C1[0],C1[0],C[0],C[0]])
y_vect = np.array([C[1],C1[1],-C2[1],-C[1],C[1]])

xy_vect = np.column_stack((x_vect, y_vect)) # Reshape coordinates
polygon = Polygon(xy_vect) # create polygon
point = Point(O2[1],O1[1]) # create point
